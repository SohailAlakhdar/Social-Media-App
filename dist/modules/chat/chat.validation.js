...
exports.getChattingGroup = exports.createChattingGroup = exports.getChat = void 0;
...
exports.getChat = {
    ...
    query: zod_1.z.strictObject({
        page: zod_1.z.coerce.number().int().min(1).max(30).optional(),
        size: zod_1.z.coerce.number().int().min(1).max(30).optional(),
    }),
};
exports.createChattingGroup = {
    body: zod_1.z
        ...
        group: zod_1.z.string().min(2).max(50000),
